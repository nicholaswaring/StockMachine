...
///
///
struct LoopingScrollView3<Content: View, SlotItem: RandomAccessCollection>: View where SlotItem.Element: Identifiable {
    ...
    var body: some View {
        GeometryReader { geometry in
            ...
            spinValue = 100
            addedValue = randomInteger3()
            let m = print("Added value 3", addedValue)
        }
    }
       
}

func randomInteger3() -> Int {
